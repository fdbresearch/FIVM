      ...
      { //foreach
        ...
        while (e2) {
          ...
          if (pItem.count() > 0) {
            ...
            payload_ksn_inventory_item.__av = pInventory.count() * pItem.count();
      ...
      { //foreach
        ...
        while (e3) {
          ...
          if (pWeather.count() > 0) {
            ...
            payload_dateid_inventory_item_weather.__av = pInventoryItem.count() * pWeather.count();
      ...
      {//foreach
        ...
        while (e4) {
          ...
          if (pLocationCensus.count() > 0) {
            ...
            payload_locn.__av = pInventoryItemWeather.count() * pLocationCensus.count();
      ...
      { //foreach
        ...
        while (e9) {
          ...
          if (pCensus.count() > 0) {
            ...
            payload_zip_location_census.__av = pLocation.count() * pCensus.count();
      ...
      { //foreach
        ...
        while (e10) {          
          ...
          if (pInventoryItemWeather.count() > 0) {
            ...
            payload_locn.locn = locn;
            payload_locn.__av = pLocationCensus.count() * pInventoryItemWeather.count();
        ...
        while (e14) {
          ...
          { //slice
            ...
            while (n15) {
              ...
              payload_zip_location_census.zip = zip;
              payload_zip_location_census.__av = pCensus.count() * pLocation.count();
        ...
        while (e20) {
          ...
          { //slice
            ...
            while (n21) {
              ...
              payload_ksn_inventory_item.ksn = ksn;
              payload_ksn_inventory_item.__av = pItem.count() * pInventory.count();
      ...
      { //foreach
        ...
        while (e3) {
          ...
          if (pInventoryItem.count() > 0) {
            ...
            payload_dateid_inventory_item_weather.dateid = dateid;
            payload_dateid_inventory_item_weather.__av = pWeather.count() * pInventoryItem.count();
      ...
      {//foreach
        ...
        while (e4) {
          ...
          if (pLocationCensus.count() > 0) {
            ...
            payload_locn.locn = locn;
            payload_dateid_inventory_item_weather.__av = pInventoryItemWeather.count() * pLocationCensus.count();
