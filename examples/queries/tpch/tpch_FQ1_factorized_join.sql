IMPORT DTREE FROM FILE 'tpch_FQ1.txt';
...
SELECT SUM(
    ...
    [lift<19>: RingFactorizedRelation<[19, VARCHAR(55), CHAR(25), CHAR(10), VARCHAR(25), INT, CHAR(10), DECIMAL, VARCHAR(23)]>](p_name, p_mfgr, p_brand, p_type, p_size, p_container, p_retailprice, p_comment) *
    [lift<27>: RingFactorizedRelation<[27, INT, CHAR(1), DECIMAL, DATE, CHAR(15), CHAR(15), INT, VARCHAR(79)]>](o_custkey, o_orderstatus, o_totalprice, o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment)
)
