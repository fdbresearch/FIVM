...
DECLARE MAP TMP_V_C(long)[][A: int, C: int] :=
  (DELTA R2)(A, C) * (V_D(long)[][C]<Local> + V_E(long)[][C]<Local>);

DECLARE MAP TMP_V_C1(long)[][A: int] :=
  AggSum([A], TMP_V_C(long)[][A, C]<Local>);

DECLARE MAP TMP_V_D(long)[][C: int] :=
  AggSum([C], (DELTA R3)(C, D));

DECLARE MAP TMP_V_E(long)[][C: int] :=
  AggSum([C], (DELTA R4)(C, E));
...
ON BATCH UPDATE OF R1 {
  ...
  QUERY2(long)[][A]<Local> += TMP_V_B(long)[][A]<Local>;
...
ON BATCH UPDATE OF R2 {
  ...
  TMP_V_C(long)[][A, C]<Local> := (DELTA R2)(A, C) * (V_D(long)[][C]<Local> + V_E(long)[][C]<Local>);

  V_C(long)[][A, C]<Local> += TMP_V_C(long)[][A, C]<Local>;

  TMP_V_C1(long)[][A]<Local> := AggSum([A], TMP_V_C(long)[][A, C]<Local>);

  V_C1(long)[][A]<Local> += TMP_V_C1(long)[][A]<Local>;
  
  QUERY2(long)[][A]<Local> += TMP_V_C1(long)[][A]<Local>;
...
ON BATCH UPDATE OF R3 {
  ...
  TMP_V_D(long)[][C]<Local> := AggSum([C], (DELTA R3)(C, D));

  V_D(long)[][C]<Local> += TMP_V_D(long)[][C]<Local>;

  TMP_V_C(long)[][A, C]<Local> := TMP_V_D(long)[][C]<Local> * V_R2(long)[][A, C]<Local>;
...
ON BATCH UPDATE OF R4 {
  ...
  TMP_V_E(long)[][C]<Local> := AggSum([C], (DELTA R4)(C, E));

  V_E(long)[][C]<Local> += TMP_V_E(long)[][C]<Local>;

  TMP_V_C(long)[][A, C]<Local> := TMP_V_E(long)[][C]<Local> * V_R2(long)[][A, C]<Local>;
