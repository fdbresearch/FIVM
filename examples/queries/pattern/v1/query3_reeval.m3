...
DECLARE MAP V_E(long)[][C: int] :=
  AggSum([C], V_R4(long)[][C, E]<Local> * V_HIJ(long)[][E]<Local>);
...
ON BATCH UPDATE OF R1 {
  ...
  QUERY3(long)[][A]<Local> := V_B(long)[][A]<Local> * V_C(long)[][A]<Local>;
...
ON BATCH UPDATE OF R2 {
  ...
  V_C(long)[][A]<Local> := AggSum([A], V_R2(long)[][A, C]<Local> * V_DE(long)[][C]<Local>); 
...
ON BATCH UPDATE OF R3 {
  ...
  V_D(long)[][C]<Local> := AggSum([C], V_R3(long)[][C, D]<Local> * V_F(long)[][D]<Local> * V_G(long)[][D]<Local>);

  V_DE(long)[][C]<Local> := V_D(long)[][C]<Local> + V_E(long)[][C]<Local>;
...
ON BATCH UPDATE OF R4 {
  ...
  V_E(long)[][C]<Local> := AggSum([C], V_R4(long)[][C, E]<Local> * V_HIJ(long)[][E]<Local>);
...
ON BATCH UPDATE OF R7 {
  ...
  V_HIJ(long)[][E]<Local> := V_H(long)[][E]<Local> + V_I(long)[][E]<Local> + V_J(long)[][E]<Local>;
