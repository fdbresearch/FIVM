...
ON BATCH UPDATE OF R1 {
  ...
  V_BC(long)[][A]<Local> := V_B(long)[][A]<Local> + V_C(long)[][A]<Local>;

  QUERY1(long)[][A]<Local> := V_BC(long)[][A]<Local> * V_D(long)[][A]<Local>;
...
ON BATCH UPDATE OF R2 {
  ...
  V_C(long)[][A]<Local> := AggSum([A], V_R2(long)[][A, C]<Local>);
...
ON BATCH UPDATE OF R3 {
  ...
  V_D(long)[][A]<Local> := AggSum([A], V_R3(long)[][A, D]<Local>);
