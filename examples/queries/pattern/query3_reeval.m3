...
DECLARE MAP V_R5(long)[][D: int, F: int] :=
  R5(D, F);
...
DECLARE MAP V_C(long)[][A: int, C: int] :=
  V_R2(long)[][A, C]<Local> * (V_D1(long)[][C]<Local> + V_E1(long)[][C]<Local>);
...
ON BATCH UPDATE OF R1 {
  ...
  QUERY3(long)[][A]<Local> := V_B(long)[][A]<Local> * V_C1(long)[][A]<Local>;
...
ON BATCH UPDATE OF R2 {
  ...
  V_C(long)[][A, C]<Local> := V_R2(long)[][A, C]<Local> * (V_D1(long)[][C]<Local> + V_E1(long)[][C]<Local>);
...
ON BATCH UPDATE OF R3 {
  ...
  V_D(long)[][C, D]<Local> := V_R3(long)[][C, D]<Local> * V_F(long)[][D]<Local> * V_G(long)[][D]<Local>;

  V_D1(long)[][C]<Local> := AggSum([C], V_D(long)[][C, D]<Local>);
...
ON BATCH UPDATE OF R4 {
  ...
  V_E(long)[][C, E]<Local> := V_R4(long)[][C, E]<Local> * (V_H(long)[][E]<Local> + V_I(long)[][E]<Local> + V_J(long)[][E]<Local>);

  V_E1(long)[][C]<Local> := AggSum([C], V_E(long)[][C, E]<Local>);
...
ON BATCH UPDATE OF R5 {
  ...
  V_F(long)[][D]<Local> := AggSum([D], V_R5(long)[][D, F]<Local>);
...
ON BATCH UPDATE OF R6 {
  ...
  V_G(long)[][D]<Local> := AggSum([D], V_R6(long)[][D, G]<Local>);
...
ON BATCH UPDATE OF R7 {
  ...
  V_H(long)[][E]<Local> := AggSum([E], V_R7(long)[][E, H]<Local>);
...
ON BATCH UPDATE OF R8 {
  ...
  V_I(long)[][E]<Local> := AggSum([E], V_R8(long)[][E, I]<Local>);
...
ON BATCH UPDATE OF R9 {
  ...
  V_J(long)[][E]<Local> := AggSum([E], V_R9(long)[][E, J]<Local>);
