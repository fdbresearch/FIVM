...
CREATE STREAM R(A int, B int) FROM FILE 'R.tbl' LINE DELIMITED CSV;
CREATE STREAM S(A int, C int, E int) FROM FILE 'S.tbl' LINE DELIMITED CSV;
CREATE STREAM T(C int, D int) FROM FILE 'T.tbl' LINE DELIMITED CSV;
