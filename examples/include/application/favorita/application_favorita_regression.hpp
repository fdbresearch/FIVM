...
class FavoritaRegressionApplication : public Application {
 public:
 ...
 private:
  void train(const dbtoaster::data_t& data /* in */,
    ...
    const auto& cofactor_matrix = data.get_V_date_SITSOH1();
...
std::unique_ptr<Application> createApplication() {
  return std::make_unique<FavoritaRegressionApplication>();
}
