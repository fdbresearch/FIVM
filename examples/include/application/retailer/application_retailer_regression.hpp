...
struct ModelEvaluator {
  ...
  double compute_rmse(double params[]) {
    ...
    for (RetailerTuple& tuple : test_dataset) {
      diff = params[0] + tuple.inventoryunits * params[1] +
             tuple.subcategory * params[2] + tuple.category * params[3] +
             tuple.categoryCluster * params[4] + tuple.prize * params[5] +
             tuple.rain * params[6] + tuple.snow * params[7] +
             tuple.maxtemp * params[8] + tuple.mintemp * params[9] +
             tuple.meanwind * params[10] + tuple.thunder * params[11] +
             tuple.rgn_cd * params[12] + tuple.clim_zn_nbr * params[13] +
             tuple.tot_area_sq_ft * params[14] +
             tuple.sell_area_sq_ft * params[15] + tuple.avghhi * params[16] +
             ...
             tuple.population * params[25] + tuple.white * params[26] +
             tuple.asian * params[27] + tuple.pacific * params[28] +
             tuple.black * params[29] + tuple.medianage * params[30] +
             tuple.occupiedhouseunits * params[31] +
             tuple.houseunits * params[32] + tuple.families * params[33] +
             tuple.households * params[34] + tuple.husbwife * params[35] +
             tuple.males * params[36] + tuple.females * params[37] +
...
class RetailerRegressionApplication : public Application {
 public:
...
std::unique_ptr<Application> createApplication() {
  return std::make_unique<RetailerRegressionApplication>();
}
