#ifndef RING_COFACTOR_DEGREE1_CONTINUOUS_HPP
#define RING_COFACTOR_DEGREE1_CONTINUOUS_HPP
...
struct RingCofactor {
    ...
    static constexpr size_t ARRAY_SZ = array_size(SZ, 2) - 1;
    ...
    explicit RingCofactor(T&& t) :  count(1), arr { t, t * t } {
...
#endif /* RING_COFACTOR_DEGREE1_CONTINUOUS_HPP */