#ifndef RING_COFACTOR_DEGREE3_CONTINUOUS_HPP
#define RING_COFACTOR_DEGREE3_CONTINUOUS_HPP
...
struct RingCofactor {
    ...
    static constexpr size_t ARRAY_SZ = array_size(SZ, 6) - 1;
...
#endif /* RING_COFACTOR_DEGREE3_CONTINUOUS_HPP */