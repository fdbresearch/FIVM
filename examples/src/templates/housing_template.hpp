#ifndef HOUSING_TEMPLATE_HPP
#define HOUSING_TEMPLATE_HPP

#include "template.hpp"

#define TEMPLATE_NAME "HOUSING"

const string dataPath = "data/housing-4-normalised";
