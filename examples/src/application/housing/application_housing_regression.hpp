...
void train(dbtoaster::data_t& data /* in */, size_t& num_iterations /* out */,
           double& error /* out */, long& train_time_ms /* out */
) {
  Stopwatch sw;
  sw.restart();
...
void Application::on_end_processing(dbtoaster::data_t& data,
  ...
  std::cout << std::endl
            << "tuples = " << data.tN << "   num_iterations: " << num_iterations
            << "   train_time_ms = " << train_time_ms << "   error: " << error
            << "   total_num_training = " << total_num_training
            << "   total_num_iterations = " << total_num_iterations
            << "   total_train_time_ms = " << total_train_time_ms << std::endl;
