...
// void producer_thread(const DataSourceConfig& cfg, std::shared_ptr<ChunkQueue>
// q,
//                      size_t batch_sz) {
...
//     const std::vector<std::pair<DataSourceConfig,
//     std::shared_ptr<ChunkQueue>>>&
//         queues,
...
//       if (cfg.isStream) {
//         dynamic_table_queues.emplace_back(cfg,
//         std::make_shared<ChunkQueue>());
//       } else {
//         static_table_queues.emplace_back(cfg,
//         std::make_shared<ChunkQueue>());
//       }
//     }
...
//               << local_time.elapsedTimeInMilliSeconds() << " ms" <<
//               std::endl;
...
//     local_time.stop();
//     std::cout << local_time.elapsedTimeInMilliSeconds() << " ms" <<
//     std::endl;
