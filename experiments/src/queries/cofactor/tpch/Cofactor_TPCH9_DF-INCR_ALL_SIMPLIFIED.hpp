...
#define AGG_LINEITEM_SIZE 13
#define AGG_LINEITEM_PARTSUPP_SIZE 15
#define AGG_SIZE 16
...
namespace dbtoaster {
  ...
  typedef AGG_value<AGG_LINEITEM_SIZE> AGG_Lineitem_value;
  struct AGG_Lineitem_entry {
    long L_ORDERKEY; long L_PARTKEY; long L_SUPPKEY; AGG_Lineitem_value __av; AGG_Lineitem_entry* nxt; AGG_Lineitem_entry* prv;
  
    explicit AGG_Lineitem_entry() : nxt(nullptr), prv(nullptr) { }
    explicit AGG_Lineitem_entry(const long c0, const long c1, const long c2, const AGG_Lineitem_value& c3) { L_ORDERKEY = c0; L_PARTKEY = c1; L_SUPPKEY = c2; __av = c3;  }
  ...
  typedef MultiHashMap<AGG_Lineitem_entry, AGG_Lineitem_value, 
  ...
  typedef AGG_Lineitem_entry DELTA_AGG_Lineitem_entry;
  typedef AGG_Lineitem_map DELTA_AGG_Lineitem_map;
  ...
  typedef AGG_Part_entry DELTA_AGG_Part_entry;
  typedef AGG_Part_map DELTA_AGG_Part_map;
  ...
  typedef AGG_Supplier_entry DELTA_AGG_Supplier_entry;
  typedef AGG_Supplier_map DELTA_AGG_Supplier_map;

  
  struct AGG_PartSupp_entry {
    long PS_PARTKEY; long PS_SUPPKEY; long __av; AGG_PartSupp_entry* nxt; AGG_PartSupp_entry* prv;
  
    explicit AGG_PartSupp_entry() : nxt(nullptr), prv(nullptr) { }
    explicit AGG_PartSupp_entry(const long c0, const long c1, const long c2) { PS_PARTKEY = c0; PS_SUPPKEY = c1; __av = c2;  }
    ...
    AGG_PartSupp_entry(const std::vector<std::string>& f, const long v) {
        /* if (f.size() < 2) return; */
        PS_PARTKEY = std::stol(f[0]); PS_SUPPKEY = std::stol(f[1]); __av = v; nxt = nullptr; prv = nullptr;
    }
  ...
  typedef MultiHashMap<AGG_PartSupp_entry, long, 
  ...
  typedef AGG_PartSupp_entry DELTA_AGG_PartSupp_entry;
  typedef AGG_PartSupp_map DELTA_AGG_PartSupp_map;
  
  
  typedef AGG_value<AGG_LINEITEM_PARTSUPP_SIZE> AGG_LineitemSupplierPart_value;
  struct AGG_LineitemSupplierPart_entry {
    long L_ORDERKEY; long N_NATIONKEY; AGG_LineitemSupplierPart_value __av; AGG_LineitemSupplierPart_entry* nxt; AGG_LineitemSupplierPart_entry* prv;
  
    explicit AGG_LineitemSupplierPart_entry() : nxt(nullptr), prv(nullptr) { }
    explicit AGG_LineitemSupplierPart_entry(const long c0, const long c1, const AGG_LineitemSupplierPart_value& c2) { L_ORDERKEY = c0; N_NATIONKEY = c1; __av = c2;  }
  ...
  typedef MultiHashMap<AGG_LineitemSupplierPart_entry, AGG_LineitemSupplierPart_value, 
  ...
  typedef AGG_LineitemSupplierPart_entry DELTA_AGG_LineitemSupplierPart_entry;
  typedef AGG_LineitemSupplierPart_map DELTA_AGG_LineitemSupplierPart_map;
  ...
  typedef AGG_Orders_entry DELTA_AGG_Orders_entry;
  typedef AGG_Orders_map DELTA_AGG_Orders_map;
  
  
  typedef AGG_value<AGG_SIZE> QUERY9_value;    
  struct QUERY9_entry {
    STRING_TYPE N_NAME; long YEAR; QUERY9_value __av; QUERY9_entry* nxt; QUERY9_entry* prv;
  
    explicit QUERY9_entry() : nxt(nullptr), prv(nullptr) { }
    explicit QUERY9_entry(const STRING_TYPE& c0, const long c1, const QUERY9_value& c2) { N_NAME = c0; YEAR = c1; __av = c2;  }
  ...
  typedef MultiHashMap<QUERY9_entry, QUERY9_value, 
  ...
  struct DELTA_LINEITEM_entry {
    long orderkey; long partkey; long suppkey; DOUBLE_TYPE linenumber; DOUBLE_TYPE quantity; DOUBLE_TYPE extendedprice; DOUBLE_TYPE discount; DOUBLE_TYPE tax; DOUBLE_TYPE returnflag; DOUBLE_TYPE linestatus; DOUBLE_TYPE shipdate; DOUBLE_TYPE commitdate; DOUBLE_TYPE receiptdate; DOUBLE_TYPE shipinstruct; DOUBLE_TYPE shipmode; DOUBLE_TYPE comment; long __av; DELTA_LINEITEM_entry* nxt; DELTA_LINEITEM_entry* prv;
  
    explicit DELTA_LINEITEM_entry() : nxt(nullptr), prv(nullptr) { }
    explicit DELTA_LINEITEM_entry(const long c0, const long c1, const long c2, const DOUBLE_TYPE c3, const DOUBLE_TYPE c4, const DOUBLE_TYPE c5, const DOUBLE_TYPE c6, const DOUBLE_TYPE c7, const DOUBLE_TYPE c8, const DOUBLE_TYPE c9, const DOUBLE_TYPE c10, const DOUBLE_TYPE c11, const DOUBLE_TYPE c12, const DOUBLE_TYPE c13, const DOUBLE_TYPE c14, const DOUBLE_TYPE c15, const long c16) { orderkey = c0; partkey = c1; suppkey = c2; linenumber = c3; quantity = c4; extendedprice = c5; discount = c6; tax = c7; returnflag = c8; linestatus = c9; shipdate = c10; commitdate = c11; receiptdate = c12; shipinstruct = c13; shipmode = c14; comment = c15; __av = c16;  }
    ...
    DELTA_LINEITEM_entry(const std::vector<std::string>& f, const long v) {
        /* if (f.size() < 16) return; */
        orderkey = std::stol(f[0]); partkey = std::stol(f[1]); suppkey = std::stol(f[2]); linenumber = std::stod(f[3]); quantity = std::stod(f[4]); extendedprice = std::stod(f[5]); discount = std::stod(f[6]); tax = std::stod(f[7]); returnflag = std::stod(f[8]); linestatus = std::stod(f[9]); shipdate = std::stod(f[10]); commitdate = std::stod(f[11]); receiptdate = std::stod(f[12]); shipinstruct = std::stod(f[13]); shipmode = std::stod(f[14]); comment = std::stod(f[15]); __av = v; nxt = nullptr; prv = nullptr;
    }
    
    FORCE_INLINE DELTA_LINEITEM_entry& modify(const long c0, const long c1, const long c2, const DOUBLE_TYPE c3, const DOUBLE_TYPE c4, const DOUBLE_TYPE c5, const DOUBLE_TYPE c6, const DOUBLE_TYPE c7, const DOUBLE_TYPE c8, const DOUBLE_TYPE c9, const DOUBLE_TYPE c10, const DOUBLE_TYPE c11, const DOUBLE_TYPE c12, const DOUBLE_TYPE c13, const DOUBLE_TYPE c14, const DOUBLE_TYPE c15) { orderkey = c0; partkey = c1; suppkey = c2; linenumber = c3; quantity = c4; extendedprice = c5; discount = c6; tax = c7; returnflag = c8; linestatus = c9; shipdate = c10; commitdate = c11; receiptdate = c12; shipinstruct = c13; shipmode = c14; comment = c15;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const {
      ar << ELEM_SEPARATOR;
    ...
    void on_batch_update_LINEITEM(const std::vector<DELTA_LINEITEM_entry>::iterator &begin, const std::vector<DELTA_LINEITEM_entry>::iterator &end) {
      ...
      { //foreach
        for (std::vector<DELTA_LINEITEM_entry>::iterator e1 = begin; e1 != end; e1++) {
          ...
          DOUBLE_TYPE l_linenumber = e1->linenumber;
          ...
          DOUBLE_TYPE l_returnflag = e1->returnflag;
          DOUBLE_TYPE l_linestatus = e1->linestatus;
          DOUBLE_TYPE l_shipdate = e1->shipdate;
          DOUBLE_TYPE l_commitdate = e1->commitdate;
          DOUBLE_TYPE l_receiptdate = e1->receiptdate;
          DOUBLE_TYPE l_shipinstruct = e1->shipinstruct;
          DOUBLE_TYPE l_shipmode = e1->shipmode;
          DOUBLE_TYPE l_comment = e1->comment;
          long count = e1->__av;

          lineitemFields[0] = l_linenumber;
          lineitemFields[1] = l_quantity;
          lineitemFields[2] = l_extendedprice;
          lineitemFields[3] = l_discount;
          lineitemFields[4] = l_tax;
          lineitemFields[5] = l_returnflag;
          lineitemFields[6] = l_linestatus;
          lineitemFields[7] = l_shipdate;
          lineitemFields[8] = l_commitdate;
          lineitemFields[9] = l_receiptdate;
          lineitemFields[10] = l_shipinstruct;
          lineitemFields[11] = l_shipmode;
          lineitemFields[12] = l_comment;

          // KEY
          entry_AGG_Lineitem.L_ORDERKEY = l_orderkey;
          entry_AGG_Lineitem.L_PARTKEY = l_partkey;
          entry_AGG_Lineitem.L_SUPPKEY = l_suppkey;

          // VALUE
          value_AGG_Lineitem.count = count;
          size_t indexOutput = 0;
          for (size_t i = 0; i < AGG_LINEITEM_SIZE; i++) {
            value_AGG_Lineitem.sums[indexOutput++] = count * lineitemFields[i];
          }
          indexOutput = 0;
          for (size_t i = 0; i < AGG_LINEITEM_SIZE; i++) {
            for (size_t j = i; j < AGG_LINEITEM_SIZE; j++) {
              value_AGG_Lineitem.cofactors[indexOutput++] = count * lineitemFields[i] * lineitemFields[j];
            }
          }

          DELTA_AGG_Lineitem.addOrDelOnZero(entry_AGG_Lineitem, value_AGG_Lineitem);
        }
      }
      ...
      { //foreach
        ...
        while (e2) {
          ...
          const AGG_Lineitem_value& vLineitem = e2->__av;
          { //slice
            ...
            while (n1) {
              ...
              long count1 = vLineitem.count;
              long count2 = AGG_Part.getValueOrDefault(se3.modify(l_partkey));
              long count3 = AGG_PartSupp.getValueOrDefault(se4.modify(l_partkey, l_suppkey));
              long count4 = e3->__av;
              long count234 = count2 * count3 * count4;
              long count = count1 * count234;

              // KEY
              entry_AGG_LineitemSupplierPart.L_ORDERKEY = l_orderkey;
              entry_AGG_LineitemSupplierPart.N_NATIONKEY = n_nationkey;

              // VALUE
              value_AGG_LineitemSupplierPart.count = count;

              size_t indexOutput = 0;
              value_AGG_LineitemSupplierPart.sums[indexOutput++] = count * l_partkey;
              value_AGG_LineitemSupplierPart.sums[indexOutput++] = count * l_suppkey;
              for (size_t i = 0; i < AGG_LINEITEM_SIZE; i++) {
                value_AGG_LineitemSupplierPart.sums[indexOutput++] = count234 * vLineitem.sums[i];
              }

              indexOutput = 0;
              value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count * l_partkey * l_partkey;
              value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count * l_partkey * l_suppkey;
              for (int i = 0; i < AGG_LINEITEM_SIZE; i++) {
                value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count234 * l_partkey * vLineitem.sums[i];
              }
              value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count * l_suppkey * l_suppkey;
              for (int i = 0; i < AGG_LINEITEM_SIZE; i++) {
                value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count234 * l_suppkey * vLineitem.sums[i];
              }
              size_t indexInput = 0;
              for (size_t i = 0; i < AGG_LINEITEM_SIZE; i++) {
                for (size_t j = i; j < AGG_LINEITEM_SIZE; j++) {
                  value_AGG_LineitemSupplierPart.cofactors[indexOutput++] = count234 * vLineitem.cofactors[indexInput++];
                }
              }

              DELTA_AGG_LineitemSupplierPart.addOrDelOnZero(entry_AGG_LineitemSupplierPart, value_AGG_LineitemSupplierPart);
      ...
      { //foreach
        ...
        while (e4) {
          ...
          const AGG_LineitemSupplierPart_value& vLineitemSupplierPart = e4->__av;
          { //slice
            ...
            while (n3) {
              ...
              { //slice
                ...
                while (n2) {
                  ...
                  // KEY
                  entry_QUERY9.N_NAME = n_name;
                  entry_QUERY9.YEAR = year;

                  // VALUE
                  long count1 = vLineitemSupplierPart.count;
                  long count2 = v5;
                  long count3 = v6;
                  long count23 = count2 * count3;
                  long count =  count1 * count23;
                  
                  value_QUERY9.count = count;

                  size_t indexOutput = 0;
                  value_QUERY9.sums[indexOutput++] = count * l_orderkey;
                  for (size_t i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    value_QUERY9.sums[indexOutput++] = count23 * vLineitemSupplierPart.sums[i];
                  }

                  indexOutput = 0;
                  value_QUERY9.cofactors[indexOutput++] = count * l_orderkey * l_orderkey;
                  for (int i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    value_QUERY9.cofactors[indexOutput++] = count23 * l_orderkey * vLineitemSupplierPart.sums[i];
                  }
                  size_t indexInput = 0;
                  for (size_t i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    for (size_t j = i; j < AGG_LINEITEM_PARTSUPP_SIZE; j++) {
                      value_QUERY9.cofactors[indexOutput++] = count23 * vLineitemSupplierPart.cofactors[indexInput++];
                    }
                  }
                  QUERY9.addOrDelOnZero(entry_QUERY9, value_QUERY9);
      ...
      { //foreach
        ...
        while (e7) {
          ...
          AGG_LineitemSupplierPart.addOrDelOnZero(se9.modify(l_orderkey, n_nationkey), e7->__av);
          e7 = e7->nxt;
        }
      }
      ...
      { //foreach
        ...
        while (e8) {
          ...
          AGG_Lineitem.addOrDelOnZero(se10.modify(l_orderkey, l_partkey, l_suppkey), e8->__av);
          e8 = e8->nxt;
        }
      }
    }
        ...
        while (e10) {
          ...
          { //slice
            ...
            while (n5) {
              ...
              const AGG_LineitemSupplierPart_value& vLineitemSupplierPart = e11->__av;
              { //slice
                ...
                while (n4) {
                  ...
                  size_t indexOutput = 0;
                  value_QUERY9.sums[indexOutput++] = count * o_orderkey;
                  for (size_t i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    value_QUERY9.sums[indexOutput++] = count23 * vLineitemSupplierPart.sums[i];
                  }

                  indexOutput = 0;
                  value_QUERY9.cofactors[indexOutput++] = count * o_orderkey * o_orderkey;
                  for (int i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    value_QUERY9.cofactors[indexOutput++] = count23 * o_orderkey * vLineitemSupplierPart.sums[i];
                  }
                  size_t indexInput = 0;
                  for (size_t i = 0; i < AGG_LINEITEM_PARTSUPP_SIZE; i++) {
                    for (size_t j = i; j < AGG_LINEITEM_PARTSUPP_SIZE; j++) {
    ...
    void on_batch_update_PARTSUPP(const std::vector<DELTA_PARTSUPP_entry>::iterator &begin, const std::vector<DELTA_PARTSUPP_entry>::iterator &end) {
      ...
      { //foreach
        for (std::vector<DELTA_PARTSUPP_entry>::iterator e14 = begin; e14 != end; e14++) {
          ...
          long v14 = e14->__av;
          DELTA_AGG_PartSupp.addOrDelOnZero(se16.modify(ps_partkey, ps_suppkey), v14);
        }
      }
        ...
        while (e15) {
          ...
          { //slice
            ...
            while (n7) {
              ...
              const AGG_Lineitem_value& vLineitem = e16->__av;
              { //slice
                ...
                while (n6) {
                  ...
                  long count1 = vLineitem.count;
                  long count2 = v15;
                  long count3 = AGG_Part.getValueOrDefault(se3.modify(l_partkey));
                  long count4 = v17;
                  long count234 = count2 * count3 * count4;
                  long count = count1 * count234;
      ...
      { //foreach
        ...
        while (e18) {
          ...
          const AGG_LineitemSupplierPart_value& vLineitemSupplierPart = e18->__av;
          { //slice
      ...
      { //foreach
        ...
        while (e21) {
          ...
          AGG_LineitemSupplierPart.addOrDelOnZero(se24.modify(l_orderkey, n_nationkey), e21->__av);
          e21 = e21->nxt;
        }
      }
    ...
    void on_batch_update_SUPPLIER(const std::vector<DELTA_SUPPLIER_entry>::iterator &begin, const std::vector<DELTA_SUPPLIER_entry>::iterator &end) {
            ...
            while (n11) {
              ...
              { //slice
                ...
                while (n10) {
                  ...
                  const AGG_Lineitem_value& vLineitem = e26->__av;

                  long count1 = vLineitem.count;
                  long count2 = v24;
                  long count3 = v25;
                  long count4 = AGG_Part.getValueOrDefault(se3.modify(l_partkey));
                  long count234 = count2 * count3 * count4;
                  long count = count1 * count234;
      ...
      { //foreach
        ...
        while (e27) {
          ...
          const AGG_LineitemSupplierPart_value& vLineitemSupplierPart = e27->__av;
          { //slice
      ...
      { //foreach
        ...
        while (e30) {
          ...
          AGG_LineitemSupplierPart.addOrDelOnZero(se34.modify(l_orderkey, n_nationkey), e30->__av);
          e30 = e30->nxt;
        }
      }
    ...
    void on_batch_update_PART(const std::vector<DELTA_PART_entry>::iterator &begin, const std::vector<DELTA_PART_entry>::iterator &end) {
        ...
        while (e33) {
          ...
          { //slice
            ...
            while (n15) {
              ...
              const AGG_Lineitem_value& vLineitem = e34->__av;
              { //slice
                ...
                while (n14) {
                  ...
                  long count2 = v33;
                  long count3 = v35;
                  long count4 = AGG_PartSupp.getValueOrDefault(se38.modify(l_partkey, l_suppkey));
                  long count234 = count2 * count3 * count4;
                  long count = count1 * count234;
      ...
      { //foreach
        ...
        while (e36) {
          ...
          const AGG_LineitemSupplierPart_value& vLineitemSupplierPart = e36->__av;
          { //slice
      ...
      { //foreach
        ...
        while (e39) {
          ...
          AGG_LineitemSupplierPart.addOrDelOnZero(se44.modify(l_orderkey, n_nationkey), e39->__av);
          e39 = e39->nxt;
        }
      }
  ...
  private:
      ...
      AGG_Lineitem_entry entry_AGG_Lineitem;
      AGG_Lineitem_value value_AGG_Lineitem;

      AGG_LineitemSupplierPart_entry entry_AGG_LineitemSupplierPart;
      AGG_LineitemSupplierPart_value value_AGG_LineitemSupplierPart;

      QUERY9_entry entry_QUERY9;
      QUERY9_value value_QUERY9;
      
      DOUBLE_TYPE lineitemFields[AGG_LINEITEM_SIZE];   
  };
