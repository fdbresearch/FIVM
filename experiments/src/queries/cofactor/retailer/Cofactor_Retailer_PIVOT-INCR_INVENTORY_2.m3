-- Incremental computation of the cofactor matrix using the pivot method for batch updates to INVENTORY
--
--
...
--------------------- MAPS ----------------------
--DECLARE MAP AGG_Inventory(float)[][locn:int, dateid:int, ksn:float, Deg_inventoryunits:int] := 0;
DECLARE MAP AGG_Location(float)[][locn:int, zip:int, Deg_rgn_cd:int, Deg_clim_zn_nbr:int, Deg_tot_area_sq_ft:int, Deg_sell_area_sq_ft:int, Deg_avghhi:int, Deg_supertargetdistance:int, Deg_supertargetdrivetime:int, Deg_targetdistance:int, Deg_targetdrivetime:int, Deg_walmartdistance:int, Deg_walmartdrivetime:int, Deg_walmartsupercenterdistance:int, Deg_walmartsupercenterdrivetime:int] := 0;
DECLARE MAP AGG_Census(float)[][zip:int, Deg_population:int, Deg_white:int, Deg_asian:int, Deg_pacific:int, Deg_blackafrican:int, Deg_medianage:int, Deg_occupiedhouseunits:int, Deg_houseunits:int, Deg_families:int, Deg_households:int, Deg_husbwife:int, Deg_males:int, Deg_females:int, Deg_householdschildren:int, Deg_hispanic:int] := 0;
DECLARE MAP AGG_Item(float)[][ksn:float, Deg_subcategory:int, Deg_category:int, Deg_categorycluster:int, Deg_prize:int] := 0;
DECLARE MAP AGG_Weather(float)[][locn:int, dateid:int, Deg_rain:int, Deg_snow:int, Deg_maxtemp:int, Deg_mintemp:int, Deg_meanwind:int, Deg_thunder:int] := 0;

DECLARE MAP AGG_LC(float)[][locn:int, Deg_zip:int, Deg_rgn_cd:int, Deg_clim_zn_nbr:int, Deg_tot_area_sq_ft:int, Deg_sell_area_sq_ft:int, Deg_avghhi:int, Deg_supertargetdistance:int, Deg_supertargetdrivetime:int, Deg_targetdistance:int, Deg_targetdrivetime:int, Deg_walmartdistance:int, Deg_walmartdrivetime:int, Deg_walmartsupercenterdistance:int, Deg_walmartsupercenterdrivetime:int, Deg_population:int, Deg_white:int, Deg_asian:int, Deg_pacific:int, Deg_blackafrican:int, Deg_medianage:int, Deg_occupiedhouseunits:int, Deg_houseunits:int, Deg_families:int, Deg_households:int, Deg_husbwife:int, Deg_males:int, Deg_females:int, Deg_householdschildren:int, Deg_hispanic:int] := 0;
--DECLARE MAP AGG_InIt(float)[][locn:int, dateid:int, Deg_ksn:int, Deg_inventoryunits:int, Deg_subcategory:int, Deg_category:int, Deg_categorycluster:int, Deg_prize:int] := 0;
--DECLARE MAP AGG_InItW(float)[][locn:int, Deg_dateid:int, Deg_ksn:int, Deg_inventoryunits:int, Deg_subcategory:int, Deg_category:int, Deg_categorycluster:int, Deg_prize:int, Deg_rain:int, Deg_snow:int, Deg_maxtemp:int, Deg_mintemp:int, Deg_meanwind:int, Deg_thunder:int] := 0;
...
DECLARE MAP DELTA_AGG_Inventory(float)[][locn:int, dateid:int, ksn:float, Deg_inventoryunits:int] := 0;
DECLARE MAP DELTA_AGG_InIt(float)[][locn:int, dateid:int, Deg_ksn:int, Deg_inventoryunits:int, Deg_subcategory:int, Deg_category:int, Deg_categorycluster:int, Deg_prize:int] := 0;
DECLARE MAP DELTA_AGG_InItW(float)[][locn:int, Deg_dateid:int, Deg_ksn:int, Deg_inventoryunits:int, Deg_subcategory:int, Deg_category:int, Deg_categorycluster:int, Deg_prize:int, Deg_rain:int, Deg_snow:int, Deg_maxtemp:int, Deg_mintemp:int, Deg_meanwind:int, Deg_thunder:int] := 0;
...
ON BATCH UPDATE OF INVENTORY {
    ...
    DELTA_AGG_Inventory(float)[][locn, dateid, ksn, Deg_inventoryunits] := 
        AggSum([locn, dateid, ksn, Deg_inventoryunits],
    ...
    DELTA_AGG_InIt(float)[][locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] :=
        AggSum([locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize],
           
            DELTA_AGG_Inventory(float)[][locn, dateid, ksn, Deg_inventoryunits] *

            AGG_Item(float)[][ksn, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] *

            DEGREE1(Deg_ksn) *

            {(Deg_ksn + Deg_inventoryunits + Deg_subcategory + Deg_category + Deg_categorycluster + Deg_prize) <= 2} *

            ( ({Deg_ksn = 0}) + ({Deg_ksn = 1} * ksn) + ({Deg_ksn = 2} * ksn * ksn) )
        );

    DELTA_AGG_InItW(float)[][locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder] :=
        AggSum([locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder],
           
            DELTA_AGG_InIt(float)[][locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] *

            AGG_Weather(float)[][locn, dateid, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder] *

            DEGREE1(Deg_dateid) *

            {(Deg_dateid + Deg_ksn + Deg_inventoryunits + Deg_subcategory + Deg_category + Deg_categorycluster + Deg_prize + Deg_rain + Deg_snow + Deg_maxtemp + Deg_mintemp + Deg_meanwind + Deg_thunder) <= 2} *
    ...
    AGG(float)[][Deg_locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic] += 
        AggSum([Deg_locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic], 
            ...
            AGG_LC(float)[][locn, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic] *

            DEGREE1(Deg_locn) *

            {(Deg_locn + Deg_dateid + Deg_ksn + Deg_inventoryunits + Deg_subcategory + Deg_category + Deg_categorycluster + Deg_prize + Deg_rain + Deg_snow + Deg_maxtemp + Deg_mintemp + Deg_meanwind + Deg_thunder + Deg_zip + Deg_rgn_cd + Deg_clim_zn_nbr + Deg_tot_area_sq_ft + Deg_sell_area_sq_ft + Deg_avghhi + Deg_supertargetdistance + Deg_supertargetdrivetime + Deg_targetdistance + Deg_targetdrivetime + Deg_walmartdistance + Deg_walmartdrivetime + Deg_walmartsupercenterdistance + Deg_walmartsupercenterdrivetime + Deg_population + Deg_white + Deg_asian + Deg_pacific + Deg_blackafrican + Deg_medianage + Deg_occupiedhouseunits + Deg_houseunits + Deg_families + Deg_households + Deg_husbwife + Deg_males + Deg_females + Deg_householdschildren + Deg_hispanic) = 2} *
...
--    AGG_Inventory(float)[][locn, dateid, ksn, Deg_inventoryunits] := 
--        AggSum([locn, dateid, ksn, Deg_inventoryunits],
--
...
--        );
    ...
    AGG_Location(float)[][locn, zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime] := 
        AggSum([locn, zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime],
    ...
    AGG_Census(float)[][zip, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic] := 
        AggSum([zip, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic],
    ...
    AGG_Item(float)[][ksn, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] :=
        AggSum([ksn, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize],
    ...
    AGG_Weather(float)[][locn, dateid, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder] :=
        AggSum([locn, dateid, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder],
    ...
    AGG_LC(float)[][locn, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic] := 
        AggSum([locn, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic],
            ...
            {(Deg_zip + Deg_rgn_cd + Deg_clim_zn_nbr + Deg_tot_area_sq_ft + Deg_sell_area_sq_ft + Deg_avghhi + Deg_supertargetdistance + Deg_supertargetdrivetime + Deg_targetdistance + Deg_targetdrivetime + Deg_walmartdistance + Deg_walmartdrivetime + Deg_walmartsupercenterdistance + Deg_walmartsupercenterdrivetime + Deg_population + Deg_white + Deg_asian + Deg_pacific + Deg_blackafrican + Deg_medianage + Deg_occupiedhouseunits + Deg_houseunits + Deg_families + Deg_households + Deg_husbwife + Deg_males + Deg_females + Deg_householdschildren + Deg_hispanic) <= 2} *

            ( ({Deg_zip = 0}) + ({Deg_zip = 1} * zip) + ({Deg_zip = 2} * zip * zip) )
        );

--    AGG_InIt(float)[][locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] :=
--        AggSum([locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize],
--           
--            AGG_Inventory(float)[][locn, dateid, ksn, Deg_inventoryunits] *
--
...
--        );
--
--    AGG_InItW(float)[][locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder] :=
--        AggSum([locn, Deg_dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize, Deg_rain, Deg_snow, Deg_maxtemp, Deg_mintemp, Deg_meanwind, Deg_thunder],
--           
--            AGG_InIt(float)[][locn, dateid, Deg_ksn, Deg_inventoryunits, Deg_subcategory, Deg_category, Deg_categorycluster, Deg_prize] *
--
...
--            AGG_LC(float)[][locn, Deg_zip, Deg_rgn_cd, Deg_clim_zn_nbr, Deg_tot_area_sq_ft, Deg_sell_area_sq_ft, Deg_avghhi, Deg_supertargetdistance, Deg_supertargetdrivetime, Deg_targetdistance, Deg_targetdrivetime, Deg_walmartdistance, Deg_walmartdrivetime, Deg_walmartsupercenterdistance, Deg_walmartsupercenterdrivetime, Deg_population, Deg_white, Deg_asian, Deg_pacific, Deg_blackafrican, Deg_medianage, Deg_occupiedhouseunits, Deg_houseunits, Deg_families, Deg_households, Deg_husbwife, Deg_males, Deg_females, Deg_householdschildren, Deg_hispanic] *
--
--            DEGREE3(Deg_locn, Deg_dateid, Deg_ksn) *
--
--            --{(Deg_locn + Deg_dateid + Deg_ksn + Deg_inventoryunits + Deg_subcategory + Deg_category + Deg_categorycluster + Deg_prize + Deg_rain + Deg_snow + Deg_maxtemp + Deg_mintemp + Deg_meanwind + Deg_thunder + Deg_zip + Deg_rgn_cd + Deg_clim_zn_nbr + Deg_tot_area_sq_ft + Deg_sell_area_sq_ft + Deg_avghhi + Deg_supertargetdistance + Deg_supertargetdrivetime + Deg_targetdistance + Deg_targetdrivetime + Deg_walmartdistance + Deg_walmartdrivetime + Deg_walmartsupercenterdistance + Deg_walmartsupercenterdrivetime + Deg_population + Deg_white + Deg_asian + Deg_pacific + Deg_blackafrican + Deg_medianage + Deg_occupiedhouseunits + Deg_houseunits + Deg_families + Deg_households + Deg_husbwife + Deg_males + Deg_females + Deg_householdschildren + Deg_hispanic) = 2} *
--
--            ( ({Deg_locn = 0}) + ({Deg_locn = 1} * locn) + ({Deg_locn = 2} * locn * locn) ) *
--            ( ({Deg_dateid = 0}) + ({Deg_dateid = 1} * dateid) + ({Deg_dateid = 2} * dateid * dateid) ) *
--            ( ({Deg_ksn = 0}) + ({Deg_ksn = 1} * locn) + ({Deg_ksn = 2} * ksn * ksn) )
--        );
}