...
ON BATCH UPDATE OF SHOP {
  ...
  V_postcode_HSIRDT1(double)[][]<Local>  +=  AggSum([],
    (((((((TMP_SUM4(long)[][postcode]<Local> * V_typeeducation_I1(long)[][postcode]<Local>) * V_pricerangerest_R1(long)[][postcode]<Local>) * V_unemployment_D1(long)[][postcode]<Local>) * V_nbbuslines_T1(long)[][postcode]<Local>) * V_house_H1(long)[][postcode]<Local>) * postcode) * postcode)
  );
...
ON BATCH UPDATE OF INSTITUTION {
  ...
  V_postcode_HSIRDT1(double)[][]<Local>  +=  AggSum([],
    (((((((TMP_SUM5(long)[][postcode]<Local> * V_pricerangerest_R1(long)[][postcode]<Local>) * V_unemployment_D1(long)[][postcode]<Local>) * V_nbbuslines_T1(long)[][postcode]<Local>) * V_sainsburys_S1(long)[][postcode]<Local>) * V_house_H1(long)[][postcode]<Local>) * postcode) * postcode)
  );
...
ON BATCH UPDATE OF RESTAURANT {
  ...
  V_postcode_HSIRDT1(double)[][]<Local>  +=  AggSum([],
    (((((((TMP_SUM6(long)[][postcode]<Local> * V_unemployment_D1(long)[][postcode]<Local>) * V_nbbuslines_T1(long)[][postcode]<Local>) * V_typeeducation_I1(long)[][postcode]<Local>) * V_sainsburys_S1(long)[][postcode]<Local>) * V_house_H1(long)[][postcode]<Local>) * postcode) * postcode)
  );
...
ON BATCH UPDATE OF DEMOGRAPHICS {
  ...
  V_postcode_HSIRDT1(double)[][]<Local>  +=  AggSum([],
    (((((((TMP_SUM7(long)[][postcode]<Local> * V_nbbuslines_T1(long)[][postcode]<Local>) * V_pricerangerest_R1(long)[][postcode]<Local>) * V_typeeducation_I1(long)[][postcode]<Local>) * V_sainsburys_S1(long)[][postcode]<Local>) * V_house_H1(long)[][postcode]<Local>) * postcode) * postcode)
  );
...
ON BATCH UPDATE OF TRANSPORT {
  ...
  V_postcode_HSIRDT1(double)[][]<Local>  +=  AggSum([],
    (((((((TMP_SUM9(long)[][postcode]<Local> * V_unemployment_D1(long)[][postcode]<Local>) * V_pricerangerest_R1(long)[][postcode]<Local>) * V_typeeducation_I1(long)[][postcode]<Local>) * V_sainsburys_S1(long)[][postcode]<Local>) * V_house_H1(long)[][postcode]<Local>) * postcode) * postcode)
  );
