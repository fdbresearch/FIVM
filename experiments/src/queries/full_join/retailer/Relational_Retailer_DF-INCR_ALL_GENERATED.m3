...
DECLARE MAP TMP_SUM3(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn: long, zip: long] :=
  AggSum([locn, zip],
...
DECLARE MAP TMP_SUM4(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn: long] :=
  AggSum([locn],
    ((TMP_SUM3(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local> * V_population_C1(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local>) * [lift<14>: RingRelation<[14, long]>](zip))
  );

DECLARE MAP TMP_SUM5(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip: long] :=
  AggSum([zip],
...
DECLARE MAP TMP_SUM6(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn: long] :=
  AggSum([locn],
    ((TMP_SUM5(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local> * V_rgn_cd_L1(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local>) * [lift<14>: RingRelation<[14, long]>](zip))
  );

DECLARE MAP TMP_SUM7(RingRelation<[4, long, long, long, double]>)[][ksn: double] :=
  AggSum([ksn],
    ((DELTA ITEM)(ksn, subcategory, category, categoryCluster, prize) * [lift<4>: RingRelation<[4, long, long, long, double]>](subcategory, category, categoryCluster, prize))
  );

DECLARE MAP TMP_SUM8(RingRelation<[2, double, double, long, long, long, double]>)[][locn: long, dateid: long] :=
  AggSum([locn, dateid],
    ((TMP_SUM7(RingRelation<[4, long, long, long, double]>)[][ksn]<Local> * V_inventoryunits_I1(long)[][locn, dateid, ksn, inventoryunits]<Local>) * [lift<2>: RingRelation<[2, double, double]>](ksn, inventoryunits))
  );

DECLARE MAP TMP_SUM9(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn: long] :=
  AggSum([locn],
    ((TMP_SUM8(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local> * V_rain_W1(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local>) * [lift<1>: RingRelation<[1, long]>](dateid))
  );

DECLARE MAP TMP_SUM10(RingRelation<[8, long, long, long, long, double, long]>)[][locn: long, dateid: long] :=
  AggSum([locn, dateid],
    ((DELTA WEATHER)(locn, dateid, rain, snow, maxtemp, mintemp, meanwind, thunder) * [lift<8>: RingRelation<[8, long, long, long, long, double, long]>](rain, snow, maxtemp, mintemp, meanwind, thunder))
  );

DECLARE MAP TMP_SUM11(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn: long] :=
  AggSum([locn],
    ((TMP_SUM10(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local> * V_ksn_II1(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local>) * [lift<1>: RingRelation<[1, long]>](dateid))
  );
...
ON BATCH UPDATE OF LOCATION {
  TMP_SUM3(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local>  :=  AggSum([locn, zip],
    ((DELTA LOCATION)(locn, zip, rgn_cd, clim_zn_nbr, tot_area_sq_ft, sell_area_sq_ft, avghhi, supertargetdistance, supertargetdrivetime, targetdistance, targetdrivetime, walmartdistance, walmartdrivetime, walmartsupercenterdistance, walmartsupercenterdrivetime) * [lift<15>: RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>](rgn_cd, clim_zn_nbr, tot_area_sq_ft, sell_area_sq_ft, avghhi, supertargetdistance, supertargetdrivetime, targetdistance, targetdrivetime, walmartdistance, walmartdrivetime, walmartsupercenterdistance, walmartsupercenterdrivetime))
  );
  TMP_SUM4(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>  :=  AggSum([locn],
    ((TMP_SUM3(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local> * V_population_C1(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local>) * [lift<14>: RingRelation<[14, long]>](zip))
  );
  V_locn_IIWLC1(RingRelation<[0, long, long, double, double, long, long, long, double, long, long, long, long, double, long, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][]<Local>  +=  AggSum([],
    ((TMP_SUM4(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local> * V_dateid_IIW1(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>) * [lift<0>: RingRelation<[0, long]>](locn))
  );
  V_zip_LC1(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>  +=  TMP_SUM4(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>;
  V_rgn_cd_L1(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local>  +=  TMP_SUM3(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local>;
}

ON BATCH UPDATE OF CENSUS {
  TMP_SUM5(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local>  :=  AggSum([zip],
    ((DELTA CENSUS)(zip, population, white, asian, pacific, blackafrican, medianage, occupiedhouseunits, houseunits, families, households, husbwife, males, females, householdschildren, hispanic) * [lift<28>: RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>](population, white, asian, pacific, blackafrican, medianage, occupiedhouseunits, houseunits, families, households, husbwife, males, females, householdschildren, hispanic))
  );
  TMP_SUM6(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>  :=  AggSum([locn],
    ((TMP_SUM5(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local> * V_rgn_cd_L1(RingRelation<[15, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][locn, zip]<Local>) * [lift<14>: RingRelation<[14, long]>](zip))
  );
  V_locn_IIWLC1(RingRelation<[0, long, long, double, double, long, long, long, double, long, long, long, long, double, long, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][]<Local>  +=  AggSum([],
    ((TMP_SUM6(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local> * V_dateid_IIW1(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>) * [lift<0>: RingRelation<[0, long]>](locn))
  );
  V_zip_LC1(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>  +=  TMP_SUM6(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>;
  V_population_C1(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local>  +=  TMP_SUM5(RingRelation<[28, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][zip]<Local>;
}

ON BATCH UPDATE OF ITEM {
  TMP_SUM7(RingRelation<[4, long, long, long, double]>)[][ksn]<Local>  :=  AggSum([ksn],
    ((DELTA ITEM)(ksn, subcategory, category, categoryCluster, prize) * [lift<4>: RingRelation<[4, long, long, long, double]>](subcategory, category, categoryCluster, prize))
  );
  TMP_SUM8(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local>  :=  AggSum([locn, dateid],
    ((TMP_SUM7(RingRelation<[4, long, long, long, double]>)[][ksn]<Local> * V_inventoryunits_I1(long)[][locn, dateid, ksn, inventoryunits]<Local>) * [lift<2>: RingRelation<[2, double, double]>](ksn, inventoryunits))
  );
  TMP_SUM9(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>  :=  AggSum([locn],
    ((TMP_SUM8(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local> * V_rain_W1(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local>) * [lift<1>: RingRelation<[1, long]>](dateid))
  );
  V_locn_IIWLC1(RingRelation<[0, long, long, double, double, long, long, long, double, long, long, long, long, double, long, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][]<Local>  +=  AggSum([],
    ((TMP_SUM9(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local> * V_zip_LC1(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>) * [lift<0>: RingRelation<[0, long]>](locn))
  );
  V_dateid_IIW1(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>  +=  TMP_SUM9(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>;
  V_ksn_II1(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local>  +=  TMP_SUM8(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local>;
  V_subcategory_I1(RingRelation<[4, long, long, long, double]>)[][ksn]<Local>  +=  TMP_SUM7(RingRelation<[4, long, long, long, double]>)[][ksn]<Local>;
}

ON BATCH UPDATE OF WEATHER {
  TMP_SUM10(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local>  :=  AggSum([locn, dateid],
    ((DELTA WEATHER)(locn, dateid, rain, snow, maxtemp, mintemp, meanwind, thunder) * [lift<8>: RingRelation<[8, long, long, long, long, double, long]>](rain, snow, maxtemp, mintemp, meanwind, thunder))
  );
  TMP_SUM11(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>  :=  AggSum([locn],
    ((TMP_SUM10(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local> * V_ksn_II1(RingRelation<[2, double, double, long, long, long, double]>)[][locn, dateid]<Local>) * [lift<1>: RingRelation<[1, long]>](dateid))
  );
  V_locn_IIWLC1(RingRelation<[0, long, long, double, double, long, long, long, double, long, long, long, long, double, long, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][]<Local>  +=  AggSum([],
    ((TMP_SUM11(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local> * V_zip_LC1(RingRelation<[14, long, double, double, double, double, double, double, double, double, double, double, double, double, double, long, long, long, long, long, double, long, long, long, long, long, long, long, long, long]>)[][locn]<Local>) * [lift<0>: RingRelation<[0, long]>](locn))
  );
  V_dateid_IIW1(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>  +=  TMP_SUM11(RingRelation<[1, long, double, double, long, long, long, double, long, long, long, long, double, long]>)[][locn]<Local>;
  V_rain_W1(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local>  +=  TMP_SUM10(RingRelation<[8, long, long, long, long, double, long]>)[][locn, dateid]<Local>;
}
