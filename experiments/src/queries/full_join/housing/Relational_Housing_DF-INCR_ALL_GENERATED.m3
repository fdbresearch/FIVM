...
DECLARE MAP V_house_H1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (HOUSE(postcode, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking) * [lift<1>: RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>](1, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking))
  );

DECLARE MAP V_sainsburys_S1(RingRelation<[11, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (SHOP(postcode, openinghoursshop, pricerangeshop, sainsburys, tesco, ms) * [lift<11>: RingRelation<[11, double, double, double, double, double]>](11, openinghoursshop, pricerangeshop, sainsburys, tesco, ms))
  );

DECLARE MAP V_typeeducation_I1(RingRelation<[16, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (INSTITUTION(postcode, typeeducation, sizeinstitution) * [lift<16>: RingRelation<[16, double, double]>](16, typeeducation, sizeinstitution))
  );

DECLARE MAP V_pricerangerest_R1(RingRelation<[18, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (RESTAURANT(postcode, openinghoursrest, pricerangerest) * [lift<18>: RingRelation<[18, double, double]>](18, openinghoursrest, pricerangerest))
  );

DECLARE MAP V_unemployment_D1(RingRelation<[20, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (DEMOGRAPHICS(postcode, averagesalary, crimesperyear, unemployment, nbhospitals) * [lift<20>: RingRelation<[20, double, double, double, double]>](20, averagesalary, crimesperyear, unemployment, nbhospitals))
  );

DECLARE MAP V_nbbuslines_T1(RingRelation<[24, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (TRANSPORT(postcode, nbbuslines, nbtrainstations, distancecitycentre) * [lift<24>: RingRelation<[24, double, double, double]>](24, nbbuslines, nbtrainstations, distancecitycentre))
  );
...
DECLARE MAP TMP_SUM1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA HOUSE)(postcode, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking) * [lift<1>: RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>](1, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking))
  );

DECLARE MAP TMP_SUM2(RingRelation<[11, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA SHOP)(postcode, openinghoursshop, pricerangeshop, sainsburys, tesco, ms) * [lift<11>: RingRelation<[11, double, double, double, double, double]>](11, openinghoursshop, pricerangeshop, sainsburys, tesco, ms))
  );

DECLARE MAP TMP_SUM3(RingRelation<[16, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA INSTITUTION)(postcode, typeeducation, sizeinstitution) * [lift<16>: RingRelation<[16, double, double]>](16, typeeducation, sizeinstitution))
  );

DECLARE MAP TMP_SUM4(RingRelation<[18, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA RESTAURANT)(postcode, openinghoursrest, pricerangerest) * [lift<18>: RingRelation<[18, double, double]>](18, openinghoursrest, pricerangerest))
  );

DECLARE MAP TMP_SUM5(RingRelation<[20, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA DEMOGRAPHICS)(postcode, averagesalary, crimesperyear, unemployment, nbhospitals) * [lift<20>: RingRelation<[20, double, double, double, double]>](20, averagesalary, crimesperyear, unemployment, nbhospitals))
  );

DECLARE MAP TMP_SUM6(RingRelation<[24, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA TRANSPORT)(postcode, nbbuslines, nbtrainstations, distancecitycentre) * [lift<24>: RingRelation<[24, double, double, double]>](24, nbbuslines, nbtrainstations, distancecitycentre))
  );
...
ON BATCH UPDATE OF INSTITUTION {
  ...
  V_postcode_HSIRDT1(RingRelation<[0, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM3(RingRelation<[16, double, double]>)[][postcode]<Local> * V_pricerangerest_R1(RingRelation<[18, double, double]>)[][postcode]<Local>) * V_unemployment_D1(RingRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_nbbuslines_T1(RingRelation<[24, double, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF RESTAURANT {
  ...
  V_postcode_HSIRDT1(RingRelation<[0, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM4(RingRelation<[18, double, double]>)[][postcode]<Local> * V_unemployment_D1(RingRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_nbbuslines_T1(RingRelation<[24, double, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF DEMOGRAPHICS {
  ...
  V_postcode_HSIRDT1(RingRelation<[0, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM5(RingRelation<[20, double, double, double, double]>)[][postcode]<Local> * V_nbbuslines_T1(RingRelation<[24, double, double, double]>)[][postcode]<Local>) * V_pricerangerest_R1(RingRelation<[18, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF TRANSPORT {
  ...
  V_postcode_HSIRDT1(RingRelation<[0, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM6(RingRelation<[24, double, double, double]>)[][postcode]<Local> * V_unemployment_D1(RingRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_pricerangerest_R1(RingRelation<[18, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingRelation<[0, double]>](0, postcode))
  );
