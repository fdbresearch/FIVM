...
DECLARE MAP V_house_H1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (HOUSE(postcode, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking) * [lift<1>: RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>](1, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking))
  );

DECLARE MAP V_sainsburys_S1(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (SHOP(postcode, openinghoursshop, pricerangeshop, sainsburys, tesco, ms) * [lift<11>: RingFactorizedRelation<[11, double, double, double, double, double]>](11, openinghoursshop, pricerangeshop, sainsburys, tesco, ms))
  );

DECLARE MAP V_typeeducation_I1(RingFactorizedRelation<[16, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (INSTITUTION(postcode, typeeducation, sizeinstitution) * [lift<16>: RingFactorizedRelation<[16, double, double]>](16, typeeducation, sizeinstitution))
  );

DECLARE MAP V_pricerangerest_R1(RingFactorizedRelation<[18, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (RESTAURANT(postcode, openinghoursrest, pricerangerest) * [lift<18>: RingFactorizedRelation<[18, double, double]>](18, openinghoursrest, pricerangerest))
  );

DECLARE MAP V_unemployment_D1(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (DEMOGRAPHICS(postcode, averagesalary, crimesperyear, unemployment, nbhospitals) * [lift<20>: RingFactorizedRelation<[20, double, double, double, double]>](20, averagesalary, crimesperyear, unemployment, nbhospitals))
  );

DECLARE MAP V_nbbuslines_T1(RingFactorizedRelation<[24, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    (TRANSPORT(postcode, nbbuslines, nbtrainstations, distancecitycentre) * [lift<24>: RingFactorizedRelation<[24, double, double, double]>](24, nbbuslines, nbtrainstations, distancecitycentre))
  );
...
DECLARE MAP TMP_SUM1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA HOUSE)(postcode, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking) * [lift<1>: RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>](1, livingarea, price, nbbedrooms, nbbathrooms, kitchensize, house, flat, unknown, garden, parking))
  );

DECLARE MAP TMP_SUM2(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA SHOP)(postcode, openinghoursshop, pricerangeshop, sainsburys, tesco, ms) * [lift<11>: RingFactorizedRelation<[11, double, double, double, double, double]>](11, openinghoursshop, pricerangeshop, sainsburys, tesco, ms))
  );

DECLARE MAP TMP_SUM3(RingFactorizedRelation<[16, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA INSTITUTION)(postcode, typeeducation, sizeinstitution) * [lift<16>: RingFactorizedRelation<[16, double, double]>](16, typeeducation, sizeinstitution))
  );

DECLARE MAP TMP_SUM4(RingFactorizedRelation<[18, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA RESTAURANT)(postcode, openinghoursrest, pricerangerest) * [lift<18>: RingFactorizedRelation<[18, double, double]>](18, openinghoursrest, pricerangerest))
  );

DECLARE MAP TMP_SUM5(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA DEMOGRAPHICS)(postcode, averagesalary, crimesperyear, unemployment, nbhospitals) * [lift<20>: RingFactorizedRelation<[20, double, double, double, double]>](20, averagesalary, crimesperyear, unemployment, nbhospitals))
  );

DECLARE MAP TMP_SUM6(RingFactorizedRelation<[24, double, double, double]>)[][postcode: double] :=
  AggSum([postcode],
    ((DELTA TRANSPORT)(postcode, nbbuslines, nbtrainstations, distancecitycentre) * [lift<24>: RingFactorizedRelation<[24, double, double, double]>](24, nbbuslines, nbtrainstations, distancecitycentre))
  );
...
ON BATCH UPDATE OF INSTITUTION {
  ...
  V_postcode_HSIRDT1(RingFactorizedRelation<[0, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM3(RingFactorizedRelation<[16, double, double]>)[][postcode]<Local> * V_pricerangerest_R1(RingFactorizedRelation<[18, double, double]>)[][postcode]<Local>) * V_unemployment_D1(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_nbbuslines_T1(RingFactorizedRelation<[24, double, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingFactorizedRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF RESTAURANT {
  ...
  V_postcode_HSIRDT1(RingFactorizedRelation<[0, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM4(RingFactorizedRelation<[18, double, double]>)[][postcode]<Local> * V_unemployment_D1(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_nbbuslines_T1(RingFactorizedRelation<[24, double, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingFactorizedRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingFactorizedRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF DEMOGRAPHICS {
  ...
  V_postcode_HSIRDT1(RingFactorizedRelation<[0, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM5(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode]<Local> * V_nbbuslines_T1(RingFactorizedRelation<[24, double, double, double]>)[][postcode]<Local>) * V_pricerangerest_R1(RingFactorizedRelation<[18, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingFactorizedRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingFactorizedRelation<[0, double]>](0, postcode))
  );
...
ON BATCH UPDATE OF TRANSPORT {
  ...
  V_postcode_HSIRDT1(RingFactorizedRelation<[0, double]>)[][]<Local>  +=  AggSum([],
    ((((((TMP_SUM6(RingFactorizedRelation<[24, double, double, double]>)[][postcode]<Local> * V_unemployment_D1(RingFactorizedRelation<[20, double, double, double, double]>)[][postcode]<Local>) * V_pricerangerest_R1(RingFactorizedRelation<[18, double, double]>)[][postcode]<Local>) * V_typeeducation_I1(RingFactorizedRelation<[16, double, double]>)[][postcode]<Local>) * V_sainsburys_S1(RingFactorizedRelation<[11, double, double, double, double, double]>)[][postcode]<Local>) * V_house_H1(RingFactorizedRelation<[1, double, double, double, double, double, double, double, double, double, double]>)[][postcode]<Local>) * [lift<0>: RingFactorizedRelation<[0, double]>](0, postcode))
  );
