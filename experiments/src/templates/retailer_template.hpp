#ifndef DBTOASTER_USRETAILER_TEMPLATE_HPP
#define DBTOASTER_USRETAILER_TEMPLATE_HPP
...
const string dataPath = "datasets/retailer";
...
#endif /* DBTOASTER_USRETAILER_TEMPLATE_HPP */